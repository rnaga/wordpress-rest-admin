...
import Dropzone from 'wordpress-rest-admin/components/Dropzone';
import withHttp from 'wordpress-rest-admin/hoc/withHttp';
import wpUrl, {wpUrlMedia} from 'wordpress-rest-admin/util/wpUrl';
import mediaClient from 'wordpress-rest-admin/services/mediaClient';
import GridList from 'wordpress-rest-admin/components/GridList';
import withGridList from 'wordpress-rest-admin/hoc/contents/withGridList';
import withMedia from 'wordpress-rest-admin/hoc/contents/withMedia';
import withActions from 'wordpress-rest-admin/hoc/withActions';
import withDropzone from 'wordpress-rest-admin/hoc/withDropzone';
